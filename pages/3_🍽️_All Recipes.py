...
st.set_page_config(page_title="All Recipes | CookitNow", page_icon="🍽️")
...
st.sidebar.write("After you filter, please click on **`Show Me Recipes`** on the main page to view the recipes.")
